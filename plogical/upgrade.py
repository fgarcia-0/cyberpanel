...
class Upgrade:
    ...
    def download_install_phpmyadmin():
        try:
            ...
            command = 'wget -q -O /usr/local/CyberCP/public/phpmyadmin.zip https://github.com/fgarcia-0/cyberpanel/raw/stable/phpmyadmin.zip'
...
"""
    ...
    def runSomeImportantBash():
        ...
        # Remove invalid crons from /etc/crontab Reference: https://github.com/fgarcia-0/cyberpanel/issues/216
...
'''
    ...
    def upgrade(branch):
        ...
        if not os.path.exists('/usr/local/lsws/bin/openlitespeed'):
            ...
            command = 'wget https://raw.githubusercontent.com/fgarcia-0/cyberpanel/stable/install/litespeed/httpd_config.xml'
            Upgrade.executioner(command, command, 0)
